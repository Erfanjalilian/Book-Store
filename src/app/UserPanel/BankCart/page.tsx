...
function BankCart() {
  ...
  const handleEdit = (cards: BankCard) => {
    console.log(cards)
    setEditData(cards);
    setShowModal(true);
  };
              ...
              cards.map((card) => (
                ...
                >
                  ...
                  <div className="mt-6 flex justify-end gap-3">
                    <button className="px-4 py-2 bg-white/20 text-white rounded-lg hover:bg-white/30 transition-colors duration-200"
                     onClick={() => handleEdit(card)}
                    >
                      ویرایش
                    </button>
                    <button className="px-4 py-2 bg-red-500/20 text-white rounded-lg hover:bg-red-500/30 transition-colors duration-200"
